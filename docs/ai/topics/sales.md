...
المبيعات جزء من PWA مع مسارات مزامنة منفصلة لتفاصيل أسطر الفواتير. توجد فحوص ذرية وأمنية وتسجيل مهمة ضمن `npm run check`. المساعد المالي يفصل تواريخ المقارنة عن الفترة الأساسية، ولا يوجّه «علينا» لذمم الزبائن المدينة (PR #205). فحص تجميع ربح «هذا الأسبوع» كان يفترض خطأً أنها نافذة متدحرجة لسبعة أيام فيوقف نشر Pages كل سبت — المنطق التقويمي (سبت→جمعة) صحيح، والحارس صار على «آخر 7 أيام» للتجميع وعلى الحساب التقويمي لـ«هذا الأسبوع». تبقى حاجة #248 لحارس الجمعة (`notEqual` هذا الأسبوع مقابل آخر 7 أيام).
