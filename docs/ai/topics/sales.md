...
المبيعات جزء من PWA مع مسارات مزامنة منفصلة لتفاصيل أسطر الفواتير. توجد فحوص ذرية وأمنية وتسجيل مهمة ضمن `npm run check`. المساعد المالي يفصل تواريخ المقارنة عن الفترة الأساسية، ولا يوجّه «علينا» لذمم الزبائن المدينة (PR #205). فحص «هذا الأسبوع / الأسبوع الماضي / آخر 7 أيام» يحرس الحساب التقويمي نفسه (الأسبوع السوري سبت→جمعة) لا اختلاف الأرقام دائماً — يوم الجمعة النافذتان الأوليان والثالثة تتطابقان بالحساب، وكان `assert.notEqual` يوقف نشر Pages.
