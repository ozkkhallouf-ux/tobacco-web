  ...
  async function inventoryAuthRequest(action, payload = {}, requireSession = true) {
    ...
    if (!response.ok) {
      const messages = {
        ...
        invalid_or_locked: "بيانات الدخول غير صحيحة. تأكد من اسم المستخدم وكلمة المرور. بعد 5 محاولات خاطئة يُقفل الحساب 15 دقيقة، وبعد انتهاء المدة تعود المحاولات من الصفر.",
