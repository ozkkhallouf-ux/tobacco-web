...
-- migration (20260914130000) لم تُطبَّق على الإنتاج بعد — تُصحِّح نافذة
-- فحص "failed" (sent_at لا created_at) وتضيف فحص dispatched العالقة.
-- الكتلة أدناه توثّق التعريف الحي الفعلي حتى الآن (قبل هذه الهجرة).
--
...
--   - رسائل تيليغرام فشلت (بنافذة sent_at لا created_at — انظر
--     migration 20260914130000)
--   - طابور تيليغرام متوقف (pending > 15 دقيقة، أو dispatched عالقة بلا
--     تقدّم > 20 دقيقة — migration 20260914130000)
