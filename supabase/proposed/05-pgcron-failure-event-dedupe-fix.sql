...
--
-- لم يُطبَّق بعد على الإنتاج — بانتظار: (أ) تشغيل الاختبارات في
-- supabase/tests/cron-job-health-transitions.sql، (ب) مراجعة المالك للـdiff
-- والخطة، كما يشترط تقرير القسم 8 في تعليمات هذا الإصلاح.
-- ============================================================================
