...
module.exports = {
  ...
  // ─── قفل النسخة الواحدة ──────────────────────────────────────────────────
  // منفذ محلّي (127.0.0.1) يحجزه المراقب طوال عمله. النظام يضمن أن نسخة واحدة
  // فقط تحجزه ويحرّره لحظة موت العملية — فلا ملف قفل ولا تنظيف يدوي.
  // غيّره فقط إذا كان برنامج آخر على الجهاز يحجز هذا الرقم.
  singleInstancePort: 47615,
