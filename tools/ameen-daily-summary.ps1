...
-- على الزبون ليس دفعة: حسم الفاتورة (#830: دائن 1.83 مقابل 43 الحسم الممنوح) والمرتجع
-- (#32: مقابل 42) والقيد الافتتاحي والتسويات والتحويلات كلها دائنة. القبض الحقيقي هو ما
-- دخل صندوقاً، والحكم بالمعرّفات وشجرة الحسابات لا بالأسماء ولا بالتاريخ والمبلغ
-- (مُثبت قراءةً على OZK2026 في 2026-09-24: 920 دفعة و191 غير دفعة، بلا استثناء):
--   • حساب الزبون تحت شجرة 121 الزبائن (e30187a7…) — يُخرج 515 (مصاريف) و12506 (سلف).
--   • مقابل السطر صندوق من شجرة 13 الأموال الجاهزة (c0dc3c06…) عدا 135 فروقات الصندوق
--     (ef5d9f4c…) — يغطي سندات القبض وFirstPay.
...
--     200 في ce 2029 دخلت صندوقين (190 + 10).
