...
param(
    ...
    # 00:40: بعد أول دورة متوقعة لمهمة المبيعات (كل 30 د) عقب منتصف الليل،
    # حتى لا يسبق مولّد اللقطة ختم sales_line_items_sync_state ليوم جديد.
    [ValidatePattern('^(?:[01]\d|2[0-3]):[0-5]\d$')][string]$StartAt = "00:40",
